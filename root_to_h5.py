...
def root_to_h5(root_file,dataset_name,extra=True):
        """                                                                                                                                              
        Read root file and converts tree to arrays, and save to hdf5 file under new group                                                                                            
        one entry for each event, datasets: 'x_tab', 'y_tab', 'z_tab' and 'e_tab'                                                                          
        are arrays of the length of the number of hits per events 
        Also creates and saves structured array with other info about events                                                                                    
        """
